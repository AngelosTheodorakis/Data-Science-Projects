...
setwd("C:/Users/User/Desktop/¢ããåëïò/R/Data analysis/House prices/house-prices-advanced-regression-techniques")
...
write.csv(df,"C:/Users/User/Desktop/¢ããåëïò/R/Data analysis/House prices/house-prices-advanced-regression-techniques\\submission.csv", row.names = FALSE)
getwd()
