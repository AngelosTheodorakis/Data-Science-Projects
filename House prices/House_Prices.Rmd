...
If we submit our scores to Kaggle, we can see that our ranking is in the middle of the board. This is not bad, because we didn't do feature engineering or some complicated machine learning models here and we managed to get a descent score just by running a multiple regression, using variable selection.<br>
